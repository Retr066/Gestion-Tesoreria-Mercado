<div wire:init='kk'>
    <div x-data="{optionsVisible : @entangle('show'), }"
        class="border border-gray-300 p-6 grid grid-cols-1 gap-6 bg-white shadow-lg rounded-lg m-3">
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <select wire:model="tipo" id="input4"
                    ...
                    <option value="Semestral">Primer Semestre(Enero - Junio)</option>
        ...
        <div x-data="{open: @entangle('viewSaldo')}">
            <div class="flex justify-center"><button wire:click="Aprobar()"
            ...
            <div x-show="open">
                ...
                @if ($this->lote !== null)
                    <div class="p-2 md:w-40 ">
                        <a class="flex items-center p-4 bg-gray-200 rounded-lg shadow-xs cursor-pointer hover:bg-gray-500 hover:text-gray-100"
                            wire:click="test()">
