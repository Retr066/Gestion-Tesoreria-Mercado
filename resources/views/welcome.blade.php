...
<body class="antialiased">
    ...
    <header class="header">
        <nav class="header__nav">
            <div class="header__nav-container">
                ...
                @if (Route::has('login'))
                    @auth
                        <a class="header__nav-a" href="{{ route('login') }}"><img class="titles__login" src="img/user.svg"
                                alt="user" /></a>
                    @else
                        <a href="{{ url('/dashboard') }}" class="header__nav-login">Inciar Session</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="header__nav-login">Register</a>
                        @endif
                    @endauth
                @endif
            </div>
    ...
    <section id="section-1" class="us">
        ...
        <div class="us__container-text">
            ...
            <p class="us__container-p">Somos el Mercado las Lomas, especialistas en el comercio. Somos una empresa de
                Villa el Salvador con más de 30 años de experiencia en la industria del comercio abasteciendo a los
                clientes más exigentes.
                <br>
                Te ofrecemos no solo frescura en los productos, sino también altos estándares de higiene porque sabemos
                lo importante que es para ti alimentarte y alimentar a otros sanamente.
            </p>
        </div>
    </section>
    <section id="section-2" class="location">
        ...
        <iframe class="location__maps"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3899.1031255023368!2d-76.92605718587672!3d-12.241296248880948!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105bb8b8aea3d77%3A0x8e0fbe3f089a7db6!2sMercado%20Las%20Lomas%20V.E.S!5e0!3m2!1ses!2spe!4v1621834608290!5m2!1ses!2spe"
            height="520" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    </section>
    <section class="social">
        ...
        <div id="section-3" class="social__location">
            ...
            <p class="social__location-p">CAL.139 NRO. S/N URB. PACHACAMAC BARRIO 3 SECT. II LIMA - LIMA - VILLA EL
                SALVADOR
            </p>
        </div>
