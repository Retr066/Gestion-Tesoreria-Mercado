...
class IngresosFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'tipo_importe' => $this->faker->randomElement(['Aportacion /Guard. /InsCrip /Cuota Asamblea.','Pago de Multas y Faenas.','Cancelacion de Deudas.','Aportacion Atrazadas Alquiler','Alumbrado Interno',
